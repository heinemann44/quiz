...
// TELA PRÓPRIA da pergunta da seção 3 (doc/tema-3/pergunta-3.png). Endereçada por
// "sec03-pergunta". Layout-base de pergunta: personagem + balão no topo, enunciado
// e opções em grade. João fica à esquerda (config). Ajuste AQUI sem afetar outras.
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-3 p-4">
        <div className="relative z-10 h-56">
          {balao && (
            <div
              className={`absolute top-0 z-20 w-4/7 ${esquerda ? 'right-0' : 'left-0'}`}
            >
              <BalaoPersonagem

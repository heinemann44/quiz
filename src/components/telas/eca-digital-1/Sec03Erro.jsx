...
// na 2ª coluna a partir da direita (bico apontando pra esquerda); e à DIREITA, no
// meio vertical, o stack enunciado + opção errada + "Volte". Reaproveita as cores
// próprias da pergunta 3 (estiloEnunciado/estiloOpcao do passo).
export default function Sec03Erro({ passo, opcaoErrada, onVoltarErro }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1">
        ...
        {personagem && (
          <div className="absolute left-0 top-0 z-10 w-1/2">
            <Personagem
        ...
        {/* Balão: 2ª coluna a partir da direita (right-1/4), topo, 2/5 da largura,
            camada de cima; bico aponta pra esquerda (personagem). */}
        {balao && (
          <div className="absolute right-1/7 top-0 z-20 w-2/5">
            <BalaoPersonagem

...
// TELA PRÓPRIA da seção 1 do Álbum 3 (Artigo 24). Layout (definido pelo usuário):
// enunciado num quadro BEGE/texto preto no topo; abaixo, a personagem ocupando
// ~90% da largura (centralizada). Sem balão. Cores vêm da config (P-11). Isolada
// por álbum.
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-4 p-4">
        ...
        {personagemSrc && (
          <Personagem src={personagemSrc} className="mx-auto w-[70%]" />
        )}
      </div>
      <RodapeAcao>
        <BotaoAcao

...
// TELA PRÓPRIA da seção 3 do Álbum 3 (Artigo 28). Layout (definido pelo usuário):
// enunciado num quadro LARANJA/texto azul-escuro no topo; abaixo, a personagem na
// largura máxima. Sem balão. Cores vêm da config (P-11). Isolada por álbum.

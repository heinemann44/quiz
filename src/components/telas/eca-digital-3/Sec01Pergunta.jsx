...
// TELA PRÓPRIA da pergunta da seção 1 do Álbum 3. Layout (definido pelo usuário):
// balão BEGE/texto preto no topo (bico pra baixo, mesmas cores da seção 1);
// personagem centralizado; e duas opções QUADRADAS (esquerda = opção 1, direita =
// opção 2) abaixo. Cores na config (P-11) — passo.estilo serve balão e quadrados.
// Isolada por álbum.
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col items-center gap-3 p-4">
        {/* balão bege com bico apontando pra baixo (pra personagem). */}
        <div
        ...
        {/* duas opções quadradas lado a lado. */}

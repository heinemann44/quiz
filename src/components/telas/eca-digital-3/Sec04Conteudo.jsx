...
// TELA PRÓPRIA da seção 4 do Álbum 3 (Artigo 29). Layout (definido pelo usuário):
// enunciado num quadro PRETO/texto branco no topo; abaixo, a personagem na largura

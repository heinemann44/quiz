...
// TELA PRÓPRIA da seção 5 do Álbum 3 (Artigo 30). Layout (definido pelo usuário):
// enunciado num quadro AZUL-CLARO/texto azul-escuro no topo; abaixo, a personagem
// na largura máxima; e um BALÃO DE FALA rosa sobreposto ao topo-direita dela
// (bico apontando pra ela). Texto e cores do balão vêm da config (P-01/P-11).
// Isolada por álbum.
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-4 p-4">
        ...
        <div className="relative flex flex-1 items-end justify-center">
          ...
          {passo.balao && (
            <div className="absolute right-0 top-2 max-w-[55%]">
              <BalaoPersonagem

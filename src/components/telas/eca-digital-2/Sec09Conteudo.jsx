...
// TELA PRÓPRIA da seção 9 do Álbum 2 (Artigo 23). Layout (definido pelo usuário):
// enunciado num quadro DOURADO CLARO/texto dourado escuro no topo; abaixo, a
// personagem na largura máxima. Sem balão. Cores vêm da config (P-11). Isolada
// por álbum.
export default function Sec09Conteudo({ passo, onAvancar }) {
